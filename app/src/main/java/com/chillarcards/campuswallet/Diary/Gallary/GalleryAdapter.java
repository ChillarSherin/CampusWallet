...
import com.chillarcards.campuswallet.networkmodels.Gallery.Image;
import com.chillarcards.campuswallet.utils.CommonDialogues_Utils;
...
//        return new TeacherTimelineAdapter.ViewHolder(v);
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        if (ImagesArraylist.size()>0){
            ...
            holder.ActivityImageHoriListRV.setLayoutManager(new GridLayoutManager(activity, 4));
        ...
        if(!TeacherCodedList.get(position).getTeacherTimelineDate().equals("")){


            String[] splited = TeacherCodedList.get(position).getTeacherTimelineDate().split("\\s");


            holder.DateTxt.setText(splited[0]);
            holder.TimeTxt.setText(splited[1]);

//            try {
//                DateFormat f = new SimpleDateFormat("dd-mm-yyyy hh:mm");
//                Date d = f.parse(TeacherCodedList.get(position).getTeacherTimelineDate());
//                DateFormat date = new SimpleDateFormat("dd/MMM\yyyy");
//                DateFormat time = new SimpleDateFormat("hh:mm a");
//                System.out.println("Date: " + date.format(d));
//                System.out.println("Time: " + time.format(d));
//
//                holder.DateTxt.setText(date.format(d));
//                holder.TimeTxt.setText(time.format(d));
//
...
//            }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
       ...
       TextView ContentTxt,DateTxt,TimeTxt,MultippleImageTV;
       ...
       Button DownloadImagesBTN;
        ...
        public ViewHolder(View itemView) {
            ...
            TimeTxt= itemView.findViewById(R.id.EventTimeTV);
